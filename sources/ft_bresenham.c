...
/*   Updated: 2022/03/07 10:18:07 by aweaver          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	bresham.i = 0.0;
	while (bresham.i < bresham.dx_start)
	{
		ft_put_pixel_img(env->img, line.x1, line.y1,
			ft_bres_colour(env, bresham.dx_start, bresham));
		bresham.i += 1.0;
...
{
	bresham.i = 0.0;
	while (bresham.i <= bresham.dy_start)
	{
		ft_put_pixel_img(env->img, line.x1, line.y1,
			ft_bres_colour(env, bresham.dy_start, bresham));
		bresham.i += 1.0;
		line.y1 += bresham.y_incr;
